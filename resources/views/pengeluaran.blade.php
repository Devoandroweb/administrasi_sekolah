    ...
    <div class="input-group w-75 float-right">
          ...
          <span class="input-group-btn">
              <button type="button" class="btn btn-primary cari_pertanggal">
               ...
               <a href="import_siswa"  class="btn btn-success print_excel " data-target="#modalImport" data-toggle="modal"><i class="material-icons">cloud_download</i>Import</a>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function read_data(status,param_tgl_awal,param_tgl_akhir) {
            ...
            columns: [
                    ...
                    { data: 'total', name: 'total',className: "text-right numeric"},
    ...
    $(document).on('click','.edit',function (argument) {
      ...
      .done(function(data) {
        ...
        $('.total_e_pengeluaran').autoNumeric('init',{aPad: false, aSign:' Rp. '});
     ...
     // date range
      ...
      $(document).on('click', '.simpanEditPengeluaran', function(event) {
          ...
          for(var i = 0; i<total_count_e_pengeluaran; i++){
            ...
            data.push({key:label_key,value:data_key.replaceAll(',','')});
