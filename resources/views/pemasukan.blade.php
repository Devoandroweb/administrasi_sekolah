...
<script type="text/javascript">
        ...
        function read_data(status,param_tgl_awal,param_tgl_akhir) {
          console.log('cari tanggal : '+param_tgl_awal+' -> '+param_tgl_akhir);
            ...
            columns: [
                    ...
                    { data: 'tanggalfix', name: 'tanggalfix', className:"align-top" },
                    { data: 'nama', name: 'nama', className:"align-top", className:"align-top" },
                    { data: 'kelas', name: 'kelas', className:"align-top" },
                    { data: 'uraianfix', name: 'uraianfix'},
                    { data: 'total', name: 'total',className: "text-right numeric font-weight-bold align-top"},
                    { data: 'action', name: 'action', orderable: false, searchable: false, className: "text-center align-top"},
    ...
    $('#simpan_editpemasukan').click( function(event) {
        ...
        while(go < tggprev.length ){
          ...
          tanggunganprev.push({tgg:tggfix.toUpperCase(),no_induk:no_induk,kelas:kelas,value:valuefix});
          go++;
        }
        ...
        $.ajax({
            ...
            type: 'POST',
            dataType: 'JSON',
            data: {_token:'{{csrf_token()}}',up_spp:spp,up_psb:psb,up_pas_1:pas_1,up_pas_2:pas_2,up_uts_1:uts_1,up_uts_2:uts_2,up_lks_1:lks_1,up_lks_2:lks_2,up_unas:unas,up_daftar_ulang:daftar_ulang,up_tanggunganprev:up_tanggunganprev
          },
        })
        .done(function() {
            Swal.fire(
