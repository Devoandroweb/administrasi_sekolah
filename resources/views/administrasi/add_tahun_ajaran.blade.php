				...
				<div class="card-body">
					<div class="row">
						<div class="col text-center">
							<img style="width: 15%" src="{{ url('public/assets/img/logo_sekolah.png') }}" alt="Generic placeholder image">
					...
					<div class="row mt-4">
						<div class="col">
							 ...
							 <form id="form_tahun_ajaran" action="{{url('tambah_tahun_ajaran')}}" method="POST">
						          @csrf
