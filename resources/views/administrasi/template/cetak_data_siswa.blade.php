...
<div class="container bg-white mt-4 mb-4">
          ...
          <h4 class="text-center font-weight-bold">Data Seluruh Siswa</h4>
          <table class="table mt-4 bg-transparent">
            <thead class="bg-info">
              <tr>
                ...
                <th class="font-weight-bold text-center">Tempat Lahir</th>
                <th class="font-weight-bold text-center">Tanggal Lahir</th>
                <th class="font-weight-bold text-center">No. Induk</th>
                <th class="font-weight-bold text-center">NISN</th>
                <th class="font-weight-bold text-center">Kelas</th>
                <th class="font-weight-bold text-center">Rombel</th>
                <th class="font-weight-bold text-center">No. Telepon</th>
                <th class="font-weight-bold text-center">Alamat</th>
            ...
            <tbody>
             @foreach($data_siswa as $key)
                  ...
                  <tr>
                    ...
                    <td>{{ $key->nama}}</td>
                    <td>{{ $key->tmp_lahir }}</td>
                    <td><?php $date_indo = Time::time_indo_convert(strtotime($key->tgl_lahir)); echo $date_indo[0]; ?></td>
                    <td>{{ $key->no_induk }}</td>
                    <td>{{ $key->nisn }}</td>
                    <td>{{ $key->kelas }}</td>
                    <td>{{ $key->rombel }}</td>
