...
<head>
  <title>Tanggungan Ijazah | Print</title>
  <!-- Required meta tags -->
...
<div class="container">
      ...
      <div class="card m-4">
        <div class="card-body">
          ...
          <h4 class="text-center font-weight-bold">Tanggungan Ijazah</h4>
          <table class="table mt-4">
            <thead>
              <tr>
                ...
                <th class="font-weight-bold text-center">Tahun Ajaran</th>
                <th class="font-weight-bold text-center">Tanggungan Ijazah (Rp)</th>
            ...
            <tbody>
              <?php $total = 0; ?>
             @foreach($tanggungan_ijazah as $key)
                  <?php 
                    $total = $total + $key->ijazah;
                  ?>
                  <tr>
                    <td class="text-center">{{ $loop->iteration }}</td>
                    <td class="text-left">{{ $key->nama }}</td>
                    <td class="text-center">{{ $key->tahun_ajaran }}</td>
                    <td class="text-right linumeric">{{ $key->ijazah }}</td>
                  </tr>
              @endforeach
                  <tr class="bg-danger text-white">
                    ...
                    <td class="text-right linumeric font-weight-bold">{{ $total }}</td>
                  </tr>
            </tbody>
          </table>
        </div>
