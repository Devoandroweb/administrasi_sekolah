  ...
  <script type="text/javascript">
    ...
    jQuery(document).ready(function() {
      ...
      $('#addpemasukan').click(function(event) {
        read_siswa();
        $('input[name=nominal_tgg_prev]').autoNumeric('init', {
          aPad: false
        });
        $('input[name=nominal_lain]').autoNumeric('init', {
          aPad: false
        });
      });
      ...
      function read_siswa() {
        $.ajax({
          ...
          .done(function(data) {
            ...
            $('input[name=spp],input[name=psb],input[name=uts_1],input[name=uts_2],input[name=pas_1],input[name=pas_2],input[name=lks_1],input[name=lks_2],input[name=unas],input[name=daftar_ulang]').autoNumeric('init', {
              aPad: false
            });
      ...
      $('#addpengeluaran').click(function(event) {
        /* Act on the event */
        $('input[name=nominal_data]').autoNumeric('init', {
          aPad: false
        });
      ...
      function hitung_pemasukan() {
        ...
        $('#form_data_pemasukan .total').autoNumeric('init', {
          aSign: ' Rp. '
        });
