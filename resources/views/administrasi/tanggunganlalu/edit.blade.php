@extends('template/template',['active' => $active ?? '5','title' => "Edit Tanggungan Sebelumnya"])
...
<form action="{{url('tanggungan_lalu-simpan-edit/'.$data->id_tgg_prev)}}" method="post">
    @csrf
    <div class="card p-2">
        ...
        <div class="card-body">
            <table class="w-100 table table-stripped">
                ...
                <tr>
                    ...
                    <td>Tahun Ajaran</td>
                    <td width="1%">:</td>
                    <td class="font-weight-bold">{{$data->tahun_ajaran}}</td>
                </tr>
            </table>
            <hr>
            <div class="row">
