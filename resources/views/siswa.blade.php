...
@endsection
@push('javascript')
<script type="text/javascript"> // data siwa
    ...
    function read_data() {
     ...
     $('#simpan-siswa').click(function(event) {
        event.preventDefault();
           ...
           $.ajax({
               ...
               type: 'POST',
               dataType: 'json',
               data: {_token:token,nama:nama,tmp_lahir:tmp_lahir,tgl_lahir:tgl_lahir,nisn:nisn,no_induk:no_induk,kelas:kelas,rombel:rombel,no_tlp:no_tlp,alamat:alamat,password:password},
           })
           .done(function() {
     ...
     $('.simpan-edit').click(function(event) {
        ...
        $.ajax({
          ...
          type: 'POST',
          dataType: 'JSON',
          data:{_token:token,up_nama:nama,up_tmp_lahir:tmp_lahir,up_tgl_lahir:tgl_lahir,up_nisn:nisn,up_no_induk:no_induk,up_no_tlp:no_tlp,up_alamat:alamat},
        })
        .done(function() {
            $('#datatable_siswa').DataTable().destroy();
            read_data();
