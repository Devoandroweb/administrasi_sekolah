...
class AdministrasiController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = DB::table('administrasi')
                    ...
                    ->orderBy('kelas')
                    ->get();
        return view('template.cetak_administrasi',['administrasi'=>$data]);
    }
    ...
    public function json_administrasi(){
        ...
        ->addColumn('action', function($row){
               $btn = '';
               $btn = $btn.'<a id="'.$row->id_administrasi.'" data-toggle="tooltip" data-placement="top" title="Edit Data Administrasi per Siswa" href="javascript:void(0)" class="btn btn-primary edit btn-sm"> <i class="material-icons">edit</i></a>';
               $btn = $btn.'<a href="'.url("cetak_administrasi_pers")."/".$row->id_administrasi.'" class="btn btn-warning print_per_siswa btn-sm" target="_blank" data-toggle="tooltip" data-placement="top" title="Print Data per Siswa"> <i class="material-icons">print</i></a>';
    ...
    public function cetak_siswa($id)
    {
        ...
        return view('template.cetak_siswa',['data'=>$data,'total'=>$total]);
    }
    ...
    public function cetak_ijazah($value='')
    {
        $ijazah = DB::table('ijazah')
            ...
            ->where('kelas', '=', 0)
            ->get();
        return view('template.cetak_tanggungan_ijazah',[ 'tanggungan_ijazah' => $ijazah]);
    }
