...
class SiswaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $table->save();
        $no_induk_adm =  $request->no_induk;
        $administrasi = Administrasi::create(['no_induk_adm' => $no_induk_adm]);
        $administrasi->save();
        return json_encode(array(
            "statusCode"=>200
        ));
    ...
    public function cetak_siswa($id){
        ...
        return view('template.cetak_siswa',['data_siswa' => $data_siswa]);
    }
    public function cetak_data_siswa()
    {
        $data_siswa = DB::table('data_siswa')->select('*')->get();
        return view('template.cetak_data_siswa',['data_siswa' => $data_siswa]);
    }
}
