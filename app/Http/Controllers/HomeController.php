...
class HomeController extends Controller
{
    ...
    {
    	return view('pemasukan',['active' => '2', 'title'=> 'Pemasukan']);
    }
    public function pengeluaran()
    {
    	return view('pengeluaran',['active' => '3', 'title'=> 'Pengeluaran']);
    }
     public function administrasi()
    {
        $data = DB::table('administrasi')->select("*")->get();
        
        return view('administrasi',['active' => '4', 'title'=> 'Administrasi', 'ijazah' => $data ]);
    }
    public function tanggungan_ijazah()
    {
        return view('tanggungan_ijazah',['active' => '4', 'title'=> 'Tanggungan Ijazah']);
    }
    public function siswa()
    {   
        return view('siswa',['active' => '5', 'title'=> 'Siswa']);
    }
    public function alumni()
    {   
        return view('alumni',['active' => '5', 'title'=> 'Alumni']);
    }
    public function riwayat_laporan()
    {
    	return view('riwayat_laporan',['active' => '6', 'title'=> 'Riwayat Laporan']);
    }
    public function rekapitulasi()
    {
        return view('rekapitulasi',['active' => '7', 'title'=> 'Rekapitulasi']);
    }
    public function tanggungan_lalu()
    {
        return view('tanggungan_lalu',['active' => '8', 'title'=> 'Tanggungan Lalu']);
    }
